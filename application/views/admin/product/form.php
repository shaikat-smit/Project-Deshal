...
<script type="text/javascript" src="<?=base_url();?>admin/js/plugins/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?=base_url();?>admin/js/custom/general.js"></script>
<script type="text/javascript" src="<?=base_url();?>admin/js/custom/form.js"></script>
        
        <div class="maincontent noright">
        	<div class="maincontentinner">
            	
                <ul class="maintabmenu multipletabmenu">
                	<li class="current"><a href="<?=base_url();?>admin/form.html">Form Styling</a></li>
                    <li><a href="<?=base_url();?>admin/editor.html">WYSIWYG Editor</a></li>
                    <li><a href="<?=base_url();?>admin/wizard.html">Wizard</a></li>
                </ul><!--maintabmenu-->
