 <div class="contenttitle">
                    	<h2 class="widgets"><span>#Edit Latest Product Row Number</span></h2>
                    </div><!--contenttitle-->
					...
					<div class="">
						...
						<form action="<?=base_url();?>index.php/admin/settings_clt/editlatestRowDone" method="post" enctype="multipart/form-data">
							<tr>
								<td class="zFormTd">
